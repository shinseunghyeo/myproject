	...
	public int insert(BoardDTO dto) {
		...
		try {
			if(dto.getOriginfile_name() != null) {
				...
				String sql = "insert into tb_board_G (b_idx, m_idx, writer, title, content, originfile_name, savefile_name) "
				...
				String sql = "insert into tb_board_G (b_idx, m_idx, writer, title, content) "
						     + " values(board_seq.nextval, ?,?,?,?)";
