...
<%
	...
	int maxUploadSize = 1024 * 1024 * 5; //업로드하는 파일의 최대크기(5 MB)
	...
	try{
		...
		String fileName = mRequest.getFilesystemName("uploadFile");//getParameter와 흡사함 
		...
		if(fileName != null){//파일이 업로드된 경우
			...
			//lastIndexOf("."): 파일이름 끝에서 부터 "."의 인덱스값을 반환함
		...
		//D:\Java_Smart_Dev\Workspace\Java_Servlet_JSP\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\
		//smart_web2023\ uploads
		//올라가는 파일 경로
